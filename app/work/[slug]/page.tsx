  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative mt-3 lg:min-h-[430px]">
          <PageTitle
            title={category.title}
          ...
          <Image
            ...
            className="mx-auto mt-10 h-auto max-h-[240px] w-auto object-contain sm:max-h-[300px] lg:absolute lg:right-0 lg:top-0 lg:mt-0 lg:max-h-[430px] lg:max-w-[min(34vw,470px)]"
          />
        </div>
